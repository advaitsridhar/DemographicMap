...
INSTANCES: dict[str, dict[str, str]] = {
    ...
    # Kosovo, Georgia, Albania, Moldova and Armenia run PxWeb too, and each
    # asked ethnicity, religion or language in its last census (2024, 2014,
    # 2023, 2024, 2022). Base URLs recalled, unverified from the sandbox.
    "XKX": {"name": "Kosovo Agency of Statistics",
            "base": "https://askdata.rks-gov.net/api/v1/en/ASKdata"},
    "GEO": {"name": "National Statistics Office of Georgia",
            "base": "https://pc-axis.geostat.ge/PXWeb/api/v1/en"},
    "ALB": {"name": "Institute of Statistics of Albania",
            "base": "https://databaza.instat.gov.al/pxweb/api/v1/en"},
    "MDA": {"name": "National Bureau of Statistics of Moldova",
            "base": "https://statbank.statistica.md/PxWeb/api/v1/en"},
    "ARM": {"name": "Statistical Committee of Armenia",
            "base": "https://armstatbank.am/pxweb/api/v1/en"},
